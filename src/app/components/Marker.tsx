export const Marker  = (props = sampleBuyer) => {
    return <a onClick={props.onClick}><img src={props.image} width={'25px'} height={'25px'} alt={'image'}/></a>
}

const sampleBuyer = {
    lat: -33.865143, // Set your default latitude
    lng: 151.209900, // Set your default longitude,
    markerId: 'buyer1',
    onClick: () => {
    ...
    buyer: true,
    seller: false,
    image: 'https://media.istockphoto.com/id/1402453901/vector/bitcoin-web-coin-internet-electronic-crypto-design-symbol-digital-pay-vector-illustration.jpg?s=612x612&w=0&k=20&c=f2sBvDTHrhQkqEkmRu8C0XZz9UFpwggMRauATUU0VQs='
}
