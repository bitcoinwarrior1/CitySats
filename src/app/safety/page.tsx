  ...
  return (
    <main className={styles.main}>
      ...
      <div id={"safety"}>
        ...
        <br></br>
        <p>
          3. Only buy/sell bitcoin with cash, no bank transfers or Paypal.
          Please report anybody that asks for payment in anything other than
          cash.
        </p>
        <br></br>
        ...
        <br></br>
        <p>
          5. If there is a local CitySats meetup in your area, feel free to do
          trades there.
        </p>
        <br></br>
